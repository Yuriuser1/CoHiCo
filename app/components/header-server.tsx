...
import { Menu, Search, Sparkles, Package } from 'lucide-react';
...
export function HeaderServer({ isScrolled = false }: HeaderProps) {
  return (
    <header
      className={cn(
    ...
    >
      <div className="container mx-auto max-w-7xl flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* Client-side components - will be rendered client-side */}
          <HeaderClient />
